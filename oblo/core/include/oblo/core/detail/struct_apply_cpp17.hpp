...
namespace oblo
{
    ...
    auto struct_apply(Function&& f, T&& obj)
    {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
        ...
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15, m16] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15, m16);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9, m10] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8, m9] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8, m9);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7, m8] = obj;
            f(m1, m2, m3, m4, m5, m6, m7, m8);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6, m7] = obj;
            f(m1, m2, m3, m4, m5, m6, m7);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5, m6] = obj;
            f(m1, m2, m3, m4, m5, m6);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4, m5] = obj;
            f(m1, m2, m3, m4, m5);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3, m4] = obj;
            f(m1, m2, m3, m4);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type, any_type>)
        {
            auto&& [m1, m2, m3] = obj;
            f(m1, m2, m3);
        }
        else if constexpr (std::is_constructible_v<type, any_type, any_type>)
        {
            auto&& [m1, m2] = obj;
            f(m1, m2);
        }
        else if constexpr (std::is_constructible_v<type, any_type>)
        {
            auto&& [m1] = obj;
            f(m1);
        }
