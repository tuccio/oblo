...
#define OBLO_VERTEX_ATTRIBUTE_JOINT_INDICES 5
#define OBLO_VERTEX_ATTRIBUTE_JOINT_WEIGHTS 6
#define OBLO_VERTEX_ATTRIBUTE_MAX 7

#define OBLO_MESH_DATA_DRAW_RANGE 0
#define OBLO_MESH_DATA_AABBS 1
#define OBLO_MESH_DATA_FULL_INDEX_BUFFER 2
#define OBLO_MESH_DATA_MAX 3
