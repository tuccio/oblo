...
namespace oblo
{
    ...
    void input_node::fill_properties_schema(data_document&, u32) const {}

    void input_node::store_properties(data_document& doc, u32 nodeIndex) const
    {
        doc.child_value(nodeIndex, "id"_hsv, property_value_wrapper{m_inputId});
    }

    void input_node::load_properties(const data_document& doc, u32 nodeIndex)
    {
