...
#define OBLO_SMOKE_GE(...) _OBLO_SMOKE_ASSERT_IMPL(GE, __VA_ARGS__)
#define OBLO_SMOKE_GT(...) _OBLO_SMOKE_ASSERT_IMPL(GT, __VA_ARGS__)
#define OBLO_SMOKE_LE(...) _OBLO_SMOKE_ASSERT_IMPL(LE, __VA_ARGS__)
#define OBLO_SMOKE_LT(...) _OBLO_SMOKE_ASSERT_IMPL(LT, __VA_ARGS__)
