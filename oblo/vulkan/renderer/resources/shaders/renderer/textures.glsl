...
#define OBLO_SAMPLER_LINEAR_CLAMP_EDGE 1
#define OBLO_SAMPLER_LINEAR_CLAMP_BLACK 2
#define OBLO_SAMPLER_LINEAR_CLAMP_WHITE 3
#define OBLO_SAMPLER_NEAREST 4
#define OBLO_SAMPLER_ANISOTROPIC 5
