...
namespace oblo::editor
{
    ...
    {
        void fetch_window_modules(dynamic_array<std::unique_ptr<window_module>>& outWindowModules) const override
        {
            outWindowModules.push_back(std::make_unique<gizmo_module>());
        }
    };
